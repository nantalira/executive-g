...
const Header = () => {
    ...
    return (
        <>
            {/* CSS untuk menghilangkan dropdown caret */}
            <style>
                {`
                        ...
                        <div className="d-flex align-items-center order-lg-3">
                            ...
                            {loading ? (
                                <div className="d-none d-lg-block">
                                    <div className="spinner-border spinner-border-sm" role="status" style={{ width: "24px", height: "24px" }}>
                                ...
                                <Dropdown align="end">
                                    <Dropdown.Toggle
                                        as="button"
                                        id="user-dropdown"
                                        className="btn p-0 border-0 d-none d-lg-block custom-dropdown-toggle"
                                        style={{
                                            background: "none",
                                            boxShadow: "none",
                                        }}
